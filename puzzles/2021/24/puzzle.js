...
// For this one, all the work happened outside of the code
// The code is just here to validate the solution I found by hand
// You can see the working-out in the comments at the bottom
...
function runAluProgram(instructions, inputQueue) {
  ...
  for(let instruction of instructions) {
    // log.debug(`${instruction.opcode} ${instruction.params.map(p => p.value).join(' ')}`);
    // log.debug(R);
...
// this function is the result of me manually decompiling the code from the input
